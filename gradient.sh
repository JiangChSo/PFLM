...
# The number of users is fixed to 20. Change NB_CLASSES, the dimension of the gradient of the gradient in the client.py and server.py.
for tuple in  18,2 14,6 20,0 18,2 16,4 14,6; do
...
#	     26,24  38,37 51,49; do
	...
	for i in {1..3}; do
		...
		$pythonCmd server.py $NB_CLIENTS BENCHMARK/gradient10/gradient10${NB_CLIENTS}c_drop_${NB_ALIVE_CLIENTS}_${NB_CRASHING_CLIENTS}.csv &
