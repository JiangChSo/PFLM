...
for tuple in 9,1 18,2 27,3 36,4 45,5 54,6 63,7 72,8 81,9 90,10 99,11 108,12; do
...
#	     26,24  38,37 51,49; do
	...
	for i in {1..3}; do
		...
		$pythonCmd server.py $NB_CLIENTS BENCHMARK/10dropout/benchmark_${NB_CLIENTS}c_drop_${NB_ALIVE_CLIENTS}_${NB_CRASHING_CLIENTS}.csv &
