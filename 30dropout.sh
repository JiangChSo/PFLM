...
for tuple in 7,3 14,6 21,9 28,12 35,15 42,18 49,21 56,24 63,27 70,30 77,33 84,36; do
...
#	     26,24  38,37 51,49; do
	...
	for i in {1..3}; do
		...
		$pythonCmd server.py $NB_CLIENTS BENCHMARK/30dropout/benchmark_${NB_CLIENTS}c_drop_${NB_ALIVE_CLIENTS}_${NB_CRASHING_CLIENTS}.csv &
